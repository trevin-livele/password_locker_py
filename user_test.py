...
class TestUser(unittest.TestCase):
    def setUp(self):
        ...
        """
        self.new_user = User("Trevin", "Livele",
                             "trevtech", "ashihundu")
    ...
    def test_user_created(self):
        ...
        """
        self.assertEqual(self.new_user.first_name, "Trevin")
        self.assertEqual(self.new_user.last_name, "Livele")
        self.assertEqual(self.new_user.username, "trevtech")
        self.assertEqual(self.new_user.password, "ashihundu")
    ...
    def test_find_user(self):
        ...
        """
        self.found_user = User.find_user("trevtech")

    def test_user_exists(self):
        """
        check whether the user account exists in the user accounts list
        """
        self.found_user = User.user_exist("trevtech")
